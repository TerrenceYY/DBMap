...
public class BNaviMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_112 = (EditText) findViewById(R.id.text_112);

        Button bikeBtn = (Button) findViewById(R.id.button_bike);
        bikeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startBikeNavi();
//                text_112.setText("clicked");
...
//
//// 调起百度地图步行导航
//                    BaiduMapNavigation.openBaiduMapNavi(para, BNaviMainActivity.this);
...
//                }
        ...
        Button walkBtn = (Button) findViewById(R.id.button_walk);
        ...
        try {
            mNaviHelper.initNaviEngine(this, new IBEngineInitListener() {
                ...
                public void engineInitSuccess() {
                    ...
                    text_112.setText("engineInitSuccess");
                    routePlanWithParam();
                }
                ...
                public void engineInitFail() {
                    ...
                    text_112.setText("engineInitFail");
                }
            });
        } catch (Exception e) {
